...
const CardUpperSection2 = ({
    index,
    title,
}) => {
  return (
    <div className="p-6 flex justify-between  flex-col z-[2]">
    <div className="flex  flex-col items-start">
      <p className="text-gray-800 text-sm">{ index < 9 ? `0${index+1}` :index+1}</p>
...
{/* arrow */}
<svg className='absolute bottom-0 mb-6' width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default CardUpperSection2
