...
const ServicesCard = ({
  ...
  return (
    <div
    key={key}
    className={`${className} bg-[#f2f2f252] backdrop-blur-[2px] rounded-[1.5rem]  hover:shadow-xl transition duration-300 overflow-hidden`}
  >
    <img
      src={image}
      alt={title}
    ...
    <div className="p-6 flex justify-between items-end">
      <div className="flex  flex-col items-start">
        <p className="text-gray-800 text-sm">0{index+1}</p>
